...
export const QUOTES: readonly Quote[] = [
  {
    ...
    name: '마이클 펠프스',
    note: '미국 · 접영/개인혼영',
    text: '오늘이 무슨 요일인지도 모릅니다. 저는 그냥 수영만 합니다.',
    said: '회원 제공',
  ...
  },
  {
    ...
    name: '케이티 러데키',
    note: '미국 · 자유형 장거리',
    text: '자기 레이스에서 이기면 됩니다. 그리고 자기 레이스에서 이긴다는 건, 시상대가 아니라 그 과정을 사랑하게 된다는 뜻입니다.',
    original:
  ...
  },
  {
    ...
    name: '케일럽 드레슬',
    note: '미국 · 자유형/접영 단거리',
    text: '나는 매일 더 나아지려고 이 자리에 왔다는 마음으로 훈련에 나섭니다.',
  ...
  },
  {
    ...
    name: '이언 소프',
    note: '호주 · 자유형',
    text: '레이스에 들어갈 때마다 나는 내가 가진 최고를 끌어내려고 합니다.',
  ...
  },
  {
    ...
    name: '사라 셰스트룀',
    note: '스웨덴 · 접영/자유형 단거리',
    text: '나는 남이 아니라 나하고만 비교합니다. 예전의 나보다 나아지고 싶을 뿐입니다.',
    original:
  ...
  },
  {
    ...
    name: '이케에 리카코',
    note: '일본 · 접영/자유형 단거리',
    text: '후회 없는 수영 인생을 위해 오늘도 끝까지 헤엄칩니다.',
  ...
  },
  {
    ...
    name: '서머 매킨토시',
    note: '캐나다 · 개인혼영/접영',
    text: '나는 늘 내가 더 나아질 방법만 생각합니다. 내 손으로 어떻게 해볼 수 있는 건 그것뿐이니까요.',
    original:
  ...
  },
  {
    ...
    text: '학교를 마치고 수영을 시작했습니다. 수영장이 없었습니다. 아무것도 없었죠. 그래서 길이가 13미터쯤 되는 호텔 개인 수영장에 가서 훈련했습니다.',
    original:
