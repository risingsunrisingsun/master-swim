    ...
    exercises: [
      {
        ...
        cue: '팔꿈치를 옆구리에 붙이고 90도로 고정한 채 아래팔만 바깥으로. 어깨가 으쓱 올라가면 승모근이 대신 일하는 것이다.',
      },
      {
        name: 'Y-T-W 레이즈',
        prescription: '각 2~3세트 × 12회',
        cue: '엎드리거나 상체를 숙이고 팔로 Y·T·W 를 만든다. 무게보다 견갑을 먼저 모으는 순서가 중요하다.',
      },
      {
        name: '견갑 후인 (밴드 로우)',
        prescription: '3세트 × 15회',
        cue: '당길 때 날개뼈를 뒤 아래로. 팔로 당기지 말고 등으로 당긴다.',
      },
    ],
    videos: [
    ...
    exercises: [
      {
        ...
        cue: '허리가 바닥에서 뜨는 순간 세트를 끝낸다. 뜨면 코어가 아니라 허리로 버티는 것이다.',
      },
      {
        name: '플랭크 · 사이드 플랭크',
        prescription: '각 3세트 × 30~45초',
        cue: '엉덩이를 들지도 떨어뜨리지도 않는다. 숨을 참으면 안 된다.',
      },
      {
        name: '팔로프 프레스',
        prescription: '3세트 × 10회 (양쪽)',
        cue: '밴드를 옆에서 당기고 몸이 끌려가지 않게 버티며 앞으로 민다. 스트로크의 비틀림과 가장 닮은 동작이다.',
      },
    ],
    videos: [
    ...
    exercises: [
      {
        ...
        cue: '옆으로 누워 무릎을 고정하고 위쪽 팔만 넘긴다. 골반이 따라 돌면 흉추가 아니라 허리가 도는 것이다.',
      },
      {
        name: '밴드 숄더 패스',
        prescription: '2세트 × 10회',
        cue: '밴드를 넓게 잡고 앞에서 뒤로 넘긴다. 좁게 잡을수록 어렵다 — 반동 없이 되는 폭에서 시작한다.',
      },
      {
        name: '폼롤러 흉추 신전',
        prescription: '2세트 × 10회',
        cue: '롤러를 등 위쪽에 대고 편다. 허리에서 꺾지 않는다.',
      },
    ],
    videos: [
    ...
    exercises: [
      {
        ...
        cue: '무릎이 안으로 모이지 않게. 40대 이후라면 체중으로 자세를 먼저 잡고 무게를 얹는다.',
      },
      {
        name: '힙 브리지 · 한다리 브리지',
        prescription: '3세트 × 12회',
        cue: '엉덩이로 밀어 올린다. 허벅지 뒤가 먼저 타면 엉덩이가 일을 안 하는 것이다.',
      },
      {
        name: '박스 점프 (선택)',
        prescription: '3세트 × 5회',
        cue: '뛰어오르되 **내려올 때는 걸어서** 내려온다. 착지 충격이 관절 부담의 대부분이다.',
      },
    ],
    videos: [
    ...
    exercises: [
      {
        ...
        cue: '팔꿈치를 높게 유지한 채 아래로 당긴다. 팔꿈치가 먼저 떨어지면 물이 빠지는 그 자세다.',
      },
      {
        name: '발목 가동성 (무릎 꿇고 발등 누르기)',
        prescription: '2세트 × 30초',
        cue: '발등이 바닥에 붙는 범위까지. 통증이 아니라 당김에서 멈춘다.',
      },
      {
        name: '사이드 플랭크 로테이션',
        prescription: '3세트 × 10회 (양쪽)',
        cue: '롤링을 버티는 힘을 만든다. 어깨가 아니라 몸통으로 돈다.',
      },
    ],
    videos: [
    ...
    exercises: [
      {
        name: '힙 브리지 홀드',
        prescription: '3세트 × 30초',
        cue: '누운 자세에서 엉덩이를 띄운 높이가 물에서의 몸 위치가 된다.',
      },
      {
        name: '밴드 스트레이트암 풀오버',
        prescription: '3세트 × 12회',
        cue: '팔을 편 채 머리 위에서 허벅지까지. 배영 풀의 궤도와 같다.',
      },
      {
        name: '어깨 신전 스트레칭',
        prescription: '2세트 × 30초',
        cue: '뒤로 손을 잡고 편다. 배영 입수 각도는 여기서 나온다.',
      },
    ],
    videos: [
    ...
    exercises: [
      {
        ...
        cue: '평영 킥의 마지막 조이는 구간이 내전이다. 여기를 놓치면 물이 새어 나간다.',
      },
      {
        name: '개구리 자세 (프로그 스트레치)',
        prescription: '2세트 × 30~45초',
        cue: '무릎을 벌리고 엎드려 골반을 낮춘다. 평영 킥 시작 자세를 땅에서 만드는 것이다.',
      },
      {
        name: '발목 외회전 스트레칭',
        prescription: '2세트 × 30초 (양쪽)',
        cue: '앉아서 발바닥을 바깥으로 돌린다. 평영 킥은 발바닥으로 물을 잡는 동작이다.',
      },
    ],
    videos: [
    ...
    exercises: [
      {
        ...
        cue: '롤러를 등 위쪽에 대고 편다. 허리에서 꺾이면 위치를 위로 옮긴다.',
      },
      {
        name: '슈퍼맨 홀드',
        prescription: '3세트 × 20초',
        cue: '엎드려 팔다리를 든다. 목을 젖히지 않는다 — 시선은 바닥.',
      },
      {
        name: '밴드 더블암 풀다운',
        prescription: '3세트 × 10회',
        cue: '양팔을 동시에 당긴다. 접영은 좌우가 함께 일하므로 한팔 운동만으로는 안 만들어진다.',
      },
    ],
    videos: [
